    ...
    <section className="text-gray-600 body-font ">
      <div className="container mx-auto flex py-6 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-5/6 flex flex-col items-center text-center md:text-left md:items-start mb-16 md:mb-0">
          <h1 className="title-font font-poppins text-2xl line-clamp-3 lg:text-4xl/relaxed leading-8 mb-4 font-medium text-gray-900">
            Find the perfect coffee
            <br className="hidden md:inline-block" /> for any time of day
          </h1>
          ...
          <div className="flex flex-wrap ">
            <div className="flex items-center mb-3 sm:w-1/2 w-full py-4">
              <div className="w-8 h-8 mr-3 inline-flex items-center justify-center rounded-full bg-indigo-400 text-white flex-shrink-0">
                <svg
                  fill="none"
                  stroke="currentColor"
                  strokeLinecap="round"
        ...
        <div className="w-5/6 lg:w-full lg:max-w-lg ml-3">
          ...
          >
			...
			c8.481-11.015,18.382-15.783,26.068-15.783S750.111,324.096,758.592,335.112z"
              ></path>
              <line
                x1="732.524"
                x2="757.722"
              ...
              <line
                ...
                strokeWidth="6"
              ></line>
              <circle cx="815.662" cy="557.071" r="49.387" fill="#fff"></circle>
              <circle
                cx="815.662"
                cy="557.071"
                r="49.387"
              ...
              <ellipse
                ...
                rx="42.31"
                ry="57.509"
                transform="rotate(-37.029 661.643 623.298)"
              ></ellipse>
              <line
                x1="691.794"
                x2="691.794"
		...
		c4.772,0,8.776-3.199,9.368-7.481l3.958-28.623H421.997z"
            ></path>
            <path
              fill="#bababa"
              d="M560.739,748.723l9.33-2.412l6.757-33.691H421.997l1.521,11.001h127.797
		c0.068,0,0.136,0,0.204,0C569.791,723.621,560.739,748.723,560.739,748.723z"
            ></path>
            <path
              fill="#6466f1"
              d="M592.342,702.936l34.962-279.51H371.52l34.962,279.51
		c0.693,5.542,5.464,9.684,11.162,9.684h163.536C586.877,712.62,591.648,708.478,592.342,702.936z"
            ></path>
            <path
              fill="#6466f1e3"
              d="M592.342,702.936l34.962-279.51H371.52l34.962,279.51
		...
		c5.698,0,10.469-4.142,11.163-9.684l34.962-279.51H371.52z"
            ></path>
            <path
              fill="none"
              stroke="#474747"
              ...
              strokeMiterlimit="10"
              strokeWidth="6"
              d="M421.997 712.62l3.958 28.623c.592 4.282 4.596 7.481 9.368 7.481H563.5c4.772 0 8.776-3.199 9.368-7.481l3.958-28.623H421.997zM592.342 702.936l34.962-279.51H371.52l34.962 279.51c.693 5.542 5.464 9.684 11.162 9.684h163.536C586.877 712.62 591.648 708.478 592.342 702.936z"
            ></path>
            <path
              fill="#646464"
		...
		c-1.794,5.264-1.794,10.977,0,16.241C640.302,418.84,641.498,423.505,632.808,423.426z"
            ></path>
            <path
              fill="#d6d6d4"
              d="M625.065,380.102H373.758l2.46-8.768c3.925-13.988,17.293-23.725,32.572-23.725
		h181.243c15.28,0,28.647,9.737,32.572,23.725L625.065,380.102z"
            ></path>
            <path
              fill="#d6d6d4"
              d="M625.065,380.102H373.758l2.46-8.768c3.925-13.988,17.293-23.725,32.572-23.725
		...
		C400.812,368.54,412.893,357.963,426.494,357.963z"
            ></path>
            <path
              fill="none"
              stroke="#474747"
		...
		c7.429,0,13.452,6.023,13.452,13.452V347.609z"
            ></path>
            <path
              fill="#d6d6d4"
              d="M575.571,347.609h-68.604v-6.405c0-7.429,6.023-13.452,13.452-13.452h41.7
		...
		c7.768,20.214,7.811,39.389,2.991,43.955C495.97,581.882,494.022,582.407,491.275,582.407z"
            ></path>
            <path
              fill="none"
              stroke="#474747"
              ...
              strokeWidth="6"
              d="
		M575.571,347.609h-68.604v-6.405c0-7.429,6.023-13.452,13.452-13.452h41.7c7.429,0,13.452,6.023,13.452,13.452V347.609z"
            ></path>
            <path
              fill="#60a06c"
		...
		c3.892,6.606,15.418,30.275,0.339,57.481C534.138,576.507,526.552,582.144,518.773,582.144L518.773,582.144z"
            ></path>
            <path
              fill="#f6f9e4"
              d="M499.286,488.491c11.792,6.666-18.084,14.876-6.078,46.116
		c8.198,21.334,6.998,38.454,3.482,41.785s-30.944-0.647-38.459-25.24C445.827,517.437,472.795,478.607,499.286,488.491z"
            ></path>
            <path
              fill="#f6f9e4"
		...
		C560.419,523.765,528.431,485.311,516.484,492.856z"
            ></path>
            <g>
              <path
                fill="#f6f9e4"
			...
			c-3.296,3.583-2.914,18.446-2.914,18.446c0.317,12.355,0.95,16.681-1.457,18.447C515.11,660.355,513.153,660.487,511.77,659.559z"
              ></path>
              <path
                fill="#f6f9e4"
			...
			c1.602-1.573,1.994-4.072,1.542-4.351C531.87,644.129,530.857,645.87,528.647,646.442z"
              ></path>
              <path
                fill="#f6f9e4"
		...
		c0.542,6.638-1.253,14.636-8,24"
            ></path>
            <path
              fill="none"
              stroke="#474747"
              ...
              strokeMiterlimit="10"
              strokeWidth="6"
              d="M601.711 151.134c6.106 25.319 1.721 40.904-3.5 50.5-9.524 17.505-26.829 24.267-28 41.889-.553 8.32 2.739 15.314 5.36 19.668M544.378 211.134c0 0-12 14-12 26.667"
            ></path>
          </svg>
        </div>
      </div>
