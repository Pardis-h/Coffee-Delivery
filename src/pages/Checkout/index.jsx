...
function Checkout(props) {
  return (
    <div className="flex flex-col lg:flex-row container mx-auto mb-12 mt-24 gap-2">
      <section className="mb-8 lg:mb-0 lg:w-5/12">
                ...
                <div className="flow-root">
                  <ul className="-my-8">
                    <li className="flex flex-col space-y-3 py-6 text-left sm:flex-row sm:space-x-5 sm:space-y-0">
                      ...
                      <div className="flex flex-1 flex-row flex-wrap justify-between items-center">
      ...
      <section className=" lg:w-7/12">
        ...
        <form class="mt-5 grid gap-6">
          <div class="relative">
            <input
              ...
              checked
            />
            <span class="peer-checked:border-indigo-500 absolute right-4 top-1/2 box-content block h-3 w-3 -translate-y-1/2 rounded-full border-8 border-gray-300 bg-white"></span>
            <label
              class="peer-checked:border-2 peer-checked:border-indigo-500 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4"
              for="radio_1"
            >
              <img
        ...
        <div className="bg-white  mx-auto mt-8  md:mt-12">
          ...
          <div className="mt-6 text-center">
            <button
              type="button"
              className="group inline-flex w-full items-center justify-center rounded-md bg-indigo-500 px-6 py-4 text-lg font-semibold text-white transition-all duration-200 ease-in-out focus:shadow hover:bg-indigo-600"
            >
              Checkout
              <svg
                xmlns="http://www.w3.org/2000/svg"
